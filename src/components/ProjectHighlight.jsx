        ...
        >
          ...
          >
            <CardHeader className='absolute bottom-0 w-full justify-center'>
              ...
              { project.repoUrl && <IconButton icon='mdi:github' textColor='black' label='GitHub' className="bg-white/80" onPress={() => handleRedirect(project.repoUrl)} /> }
              { project.previewUrl && <IconButton icon='material-symbols:search-rounded' textColor='black' className="bg-white/80" label='Preview' onPress={() => handleRedirect(project.previewUrl)} /> }
              </div>
            </CardHeader>
            <Image
              removeWrapper
