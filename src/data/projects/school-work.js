export default [
  ...
  },
  {
    ...
    year: "2025",
    tagline:
      "An assignment to create a job searching app using React and Next.js with a component library.",
  ...
  },
  {
    ...
    year: "2025",
    tagline:
      "This todolist project was our first introduction to working with TypeScript.",
  ...
  },
  {
    ...
    year: "2024",
    tagline:
      "A simple webshop interface that gets data from a third party API and implements Google Analytics.",
  ...
  },
  {
    ...
    year: "2024",
    tagline:
      "Our first assignment where we got to work in a team of multiple students was to create a quiz app using HTML, CSS and JavaScript.",
  ...
  },
  {
    ...
    `,
    tags: ["HTML", "CSS", "JavaScript"],
    images: ["portfolio-assignment__00.png", "portfolio-assignment__01.png"],
  },
  {
    id: "1",
    ...
    year: "2024",
    tagline:
      "Our first assignment was to code a portfolio site using HTML and CSS based on a Figma design.",
